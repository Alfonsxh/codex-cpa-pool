...
export const configurationCategories = [
  ...
  { name: "admin.cpa_containers", eyebrow: "CPA CONTAINERS", description: t("admin.cpa_containers_description") },
...
export const configurationSections: Array<{
  ...
  { id: "requests", category: "admin.requests_accounts", title: t("admin.gateway_request_policy"), description: t("admin.gateway_request_policy_description") },
  { id: "cpa-requests", category: "admin.cpa_containers", title: t("admin.requests_proxies"), description: t("admin.default_upstream_proxy_retries_image_tools") },
  { id: "codex-ticket", category: "admin.cpa_containers", title: t("admin.ticket_configuration"), description: t("admin.ticket_configuration_description") },
  { id: "cpa-container", category: "admin.cpa_containers", title: t("admin.cpa_container_settings"), description: t("admin.cpa_container_settings_description") },
  ...
  { id: "provisioning", category: "admin.cpa_containers", title: t("admin.provisioning_runtime"), description: t("admin.new_account_ports_listen_address_update_image") },
  { id: "logging", category: "admin.cpa_containers", title: t("admin.logs_diagnostics"), description: t("admin.debug_settings_file_logs_retention_limits") },
...
const legacySections: Record<string, string> = {
  ...
  "品牌与身份": "brand", "系统设置": "general", "CPA 请求": "cpa-requests", "账号自动切换": "failover",
...
export function configurationSectionFor(field: Pick<ConfigurationField, "key">, originalGroup: string) {
  const key = field.key;
  const id = key === "software.cpa_auto_check" ? "provisioning" : key.startsWith("plugins.") || key.startsWith("software.") ? "codex-ticket" : ["cpa.debug", "cpa.logging_to_file", "cpa.usage_statistics_enabled", "cpa.passthrough_headers", "cpa.session_affinity", "cpa.session_affinity_ttl", "cpa.usage_queue_retention_seconds"].includes(key) ? "cpa-container"
    ...
    : key.startsWith("collector.") ? "collection"
    ...
    : key.startsWith("cpa.") ? "cpa-requests"
    : key === "gateway.max_reasoning_effort" ? "requests"
